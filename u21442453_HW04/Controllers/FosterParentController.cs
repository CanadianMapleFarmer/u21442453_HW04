...
namespace u21442453_HW04.Controllers
{
    public class FosterParentController : Controller
    {
        ...
        [HttpGet]
        public ActionResult becomeFosterParent()
        {
        ...
        [HttpPost]
        public ActionResult becomeFosterParent(string fName, string lName, int age, string email, string phoneNumber, FormCollection fc)
        {
            string grade = fc["grade"];
            try
            {
                string routePath = Server.MapPath("~/App_Data/FosterParents.txt");
                ...
                ViewBag.Message = $"Thank you, {fName} {lName} for fostering a {grade} orphan.";
